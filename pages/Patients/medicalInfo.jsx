    ...
    <>
     ...
     w-[70%]
      ...
      "
        ...
        <div class="inline-flex mt-[5%] ml-[15%] rounded-md shadow-sm">
          <a
            onClick={push}
            href="#"
            aria-current="page"
            class="px-4 py-2 text-sm font-medium text-blue-700 bg-blue-900 border border-gray-200 rounded-l-lg hover:bg-green-100 focus:z-10 focus:ring-2 focus:ring-blue-700 focus:text-blue-700 green:bg-green-700 green:border-green-600 dark:text-white dark:hover:text-white dark:hover:bg-gray-600 dark:focus:ring-blue-500 dark:focus:text-white"
          >
            Save
          </a>
          <a
            href="#"
            class="px-4 py-2 text-sm font-medium text-gray-900 bg-green-900 border-t border-b border-green-900 hover:bg-green-900 hover:text-blue-700 focus:z-10 focus:ring-2 focus:ring-blue-700 focus:text-green-900 green:bg-green-900 green:border-green-900 dark:text-white dark:hover:text-white green:hover:bg-green-900 dark:focus:ring-blue-500 dark:focus:text-white"
          >
            Reset
          </a>
          <a
            href="#"
            class="px-4 py-2 text-sm font-medium text-gray-900 bg-red-900 border border-red-900 rounded-r-md hover:bg-red-900 hover:text-blue-700 focus:z-10 focus:ring-2 focus:ring-blue-700 focus:text-red-900 red:bg-red-900 dark:border-gray-600 dark:text-white dark:hover:text-white red:hover:bg-red-900 dark:focus:ring-blue-500 dark:focus:text-white"
          >
            Cancel
          </a>
        </div>
